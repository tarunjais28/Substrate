...
use frame_support::{
	...
	traits::{Contains, OnInitialize, ContainsLengthBound}
};
...
impl did::Config for Test {
    type Event = did::Event;
}

impl validator_set::Config for Test {
    type Event = validator_set::Event;
...
fn last_event() -> RawEvent<u64, did::Did, H256, DefaultInstance> {
...
// 		assert_noop!(Treasury::accept_curator(Origin::signed(4), 0), balances::Error::<Test, _>::InsufficientBalance);
