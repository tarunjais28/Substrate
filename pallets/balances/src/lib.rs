...
use frame_support::{
    ...
    traits::{
        ...
        OnKilledAccount, OnUnbalanced, ReservableCurrency, SignedImbalance, StoredMap, TryDrop,
        WithdrawReasons,
    },
    weights::Weight,
...
impl<T: Config<I>, I: Instance> Subtrait<I> for T {
    ...
    type DidResolution = T::DidResolution;
...
mod imbalances {
    use super::{
        result, Config, DefaultInstance, Imbalance, Instance, RuntimeDebug, Saturating,
        StorageValue, Subtrait, TryDrop, Zero,
    };
    use sp_std::mem;
...
impl<T: Subtrait<I>, I: Instance> Config<I> for ElevatedTrait<T, I> {
    type Balance = T::Balance;
    type Event = ();
    type DustRemoval = ();
    type ExistentialDeposit = T::ExistentialDeposit;
    ...
    T::Balance: MaybeSerializeDeserialize + Debug,
{
    ...
    fn make_free_balance_be(
			...
			-> Result<SignedImbalance<Self::Balance, Self::PositiveImbalance>, DispatchError>
		{
			...
			ensure!(value.saturating_add(account.reserved) >= ed || !is_new, Error::<T, I>::ExistentialDeposit);
